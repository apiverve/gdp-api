...
namespace APIVerve.API.GDPData
{
    ...
    /// <summary>
    /// Client for the GDPData API
    /// </summary>
    public class GDPDataAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/gdp";
        ...
        {
            { "country", new ValidationRule { Type = "string", Required = true, MinLength = 2, MaxLength = 3 } },
            { "year", new ValidationRule { Type = "integer", Required = false, Min = 1960, Max = 2030 } }
        };
        ...
        public GDPDataAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GDPDataAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GDPDataAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, GDPDataQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(GDPDataQueryOptions options)
        {
        ...
        public ResponseObj Execute(GDPDataQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(GDPDataQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(GDPDataQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(GDPDataQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(GDPDataQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(GDPDataQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(GDPDataQueryOptions options)
        {
