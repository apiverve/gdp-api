...
class gdpWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/gdp');
        }
        ...
        this.validationRules = {"country":{"type":"string","required":true,"minLength":2,"maxLength":3},"year":{"type":"integer","required":false,"min":1960,"max":2030}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/gdp`);
        }
    }
