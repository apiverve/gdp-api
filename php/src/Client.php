 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/gdp?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/gdp';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\GdpClient] {$message}\n";
        }
    }
}
