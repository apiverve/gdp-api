...
```gradle
dependencies {
    implementation 'com.github.apiverve:gdp-api:1.1.13'
}
```
...
```java
import com.apiverve.gdp.GDPDataAPIClient;
import com.apiverve.gdp.APIResponse;
import com.apiverve.gdp.APIException;

// Initialize the client
GDPDataAPIClient client = new GDPDataAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/gdp](https://docs.apiverve.com/ref/gdp)
...
- **Documentation:** [https://docs.apiverve.com/ref/gdp](https://docs.apiverve.com/ref/gdp)
- **Issues:** [GitHub Issues](https://github.com/apiverve/gdp-api/issues)
