/*
 * GDP Data API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the GDP Data API.
 * API Documentation: https://docs.apiverve.com/ref/gdp
 */
...
{
    class GDPDataExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/gdp";

        /// <summary>
        /// Make a GET request to the GDP Data API
        /// </summary>
        static async Task<JsonDocument> CallGDPDataAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling GDP Data API...\n");

            var result = await CallGDPDataAPI();
