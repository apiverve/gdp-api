# GDP Data API - Examples

This folder contains example code for using the GDP Data API across different platforms.
...
const response = await fetch('https://api.apiverve.com/v1/gdp', {
...
response = requests.get('https://api.apiverve.com/v1/gdp',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/gdp");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/gdp](https://docs.apiverve.com/ref/gdp)
